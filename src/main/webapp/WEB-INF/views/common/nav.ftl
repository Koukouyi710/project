<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li>
            <a href="/user/order/findorder"><i class="fa fa-fw fa-list-alt"></i> 订单</a>
        </li>
        <li class="dropdown is-closed">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/user/product/findproduct">列表</a></li>
                <li><a href="/user/product/productadd">新增</a></li>
            </ul>
        </li>
        <li class="dropdown is-closed">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/user/category/categoryadd">新增</a></li>
            </ul>
        </li>
        <li class="dropdown is-closed">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/user/finduser">列表</a></li>
                <li><a href="/user/useradd">新增</a></li>
            </ul>
        </li>
        <li>
