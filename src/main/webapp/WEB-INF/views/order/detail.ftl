        ...
        <div id="page-content-wrapper">
            <div class="container">
                ...
                <#if orderVO.status == 20>
                    <a href="/project/user/order/send/${order.id}" type="button" class="btn btn-default btn-primary">订单发货</a>
                </#if>
                    <#if orderVO.status == 10>
                     <a href="" class="btn btn-info">修改地址</a>
                    <a href="/project/user/order/cancel/${order.id}" type="button" class="btn btn-default btn-danger">取消订单</a>
                        </#if>
                        <a href="/project/user/order/findorder"><button type="submit" class="btn btn-default" style="float: right">返回</button></a>
                    </div>
                </div>
            </div>
        </div>
