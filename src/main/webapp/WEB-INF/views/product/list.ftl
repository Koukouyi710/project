                    ...
                    <#--<#list 1..uplist.getTotalPages() as index>
                        ...
                        <#else>
                            ...
                            <#if (uplist.getTotalPages() > 0)>
                                <li <#if (uplist.getCurrentPage() == 1)>class="disabled"</#if>><a href="/project/user/product/findproduct?currentPageup=1">1</a></li>
                            </#if>
                        ...
                        <#--如果不只有一页-->
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < uplist.getTotalPages())>
                                        <li <#if (uplist.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/product/findproduct?currentPageup=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
                            ...
                            <#--最后页&ndash;&gt;-->
                                <li <#if (uplist.getCurrentPage() == uplist.getTotalPages())>class="disabled"</#if>><a href="/project/user/product/findproduct?currentPageup=${uplist.getTotalPages()}" >${uplist.getTotalPages()}</a></li>
                            </#if>
                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <#if "${product.status}"==2>
                            ...
                            <#--<td>${product.status}</td>-->
                                <td width="200">${product.createTime?string('yyyy-MM-dd HH:mm:ss')}</td>
                                <td width="200">${product.updateTime?string('yyyy-MM-dd HH:mm:ss')}</td>
                                <td colspan="2"><a href="/project/user/product/productupdate/${product.id}">修改</a>
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < downlist.getTotalPages())>
                                        <li <#if (downlist.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/product/findproduct?currentPagedown=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
