        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <a href="/project/user/product/findproduct"><button type="submit" class="btn btn-default" style="float: right">返回</button></a>
                    <table class="table table-bordered table-condensed">
                        ...
                        <#list SproductList.getList() as product>
                            ...
                            <#--<td>${product.status}</td>-->
                             ...
                             <#if checkstatus==1>
                                    <td><a href="/project/user/product/productupdate/${product.id}">修改</a></td>
                ...
                <#--分页-->
                    ...
                    <#else>
                        <li><a href="/project/user/product/search?currentPage=${SproductList.getCurrentPage() - 1}">上一页</a></li>
                    </#if>
                        ...
                        <#--<#list 1..uplist.getTotalPages() as index>
                            ...
                            <#if (SproductList.getTotalPages() > 0)>
                                <li <#if (SproductList.getCurrentPage() == 1)>class="disabled"</#if>><a href="/project/user/product/search?currentPage=1">1</a></li>
                            </#if>
                        ...
                        <#--如果不只有一页-->
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < SproductList.getTotalPages())>
                                        <li <#if (SproductList.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/product/search?currentPage=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
                            ...
                            <#--最后页&ndash;&gt;-->
                                <li <#if (SproductList.getCurrentPage() == SproductList.getTotalPages())>class="disabled"</#if>><a href="/project/user/product/search?currentPage=${SproductList.getTotalPages()}" >${SproductList.getTotalPages()}</a></li>
                            </#if>

                    <#if SproductList.getCurrentPage() gte SproductList.getTotalPages()>
                        <li class="disabled"><a href="#">下一页</a></li>
                    <#else>
                        <li><a href="/project/user/product/search?currentPage=${SproductList.getCurrentPage() + 1}">下一页</a></li>
                    </#if>
                        </ul>
                    </div>
                </div>
