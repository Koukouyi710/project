        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            ...
                            <td><a href="/project/user/category/update/${category.id}">修改</a>
                ...
                <#--分页-->
                    ...
                    <#else>
                        <li><a href="/project/user/category/find?currentPage=${pagelist.getCurrentPage() - 1}">上一页</a></li>
                    </#if>
                    ...
                    <#--<#list 1..pagelist.getTotalPages() as index>
                        ...
                        <#else>
                            <li><a href="/project/user/category/find?currentPage=${index}">${index}</a></li>
                        </#if>
                    </#list>-->

                            <#if (pagelist.getTotalPages() > 0)>
                                <li <#if (pagelist.getCurrentPage() == 1)>class="disabled"</#if>><a href="/project/user/category/find?currentPage=1">1</a></li>
                            </#if>
                        ...
                        <#--如果不只有一页-->
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < pagelist.getTotalPages())>
                                        <li <#if (pagelist.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/category/find?currentPage=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
                            ...
                            <#--最后页&ndash;&gt;-->
                                <li <#if (pagelist.getCurrentPage() == pagelist.getTotalPages())>class="disabled"</#if>><a href="/project/user/category/find?currentPage=${pagelist.getTotalPages()}" >${pagelist.getTotalPages()}</a></li>
                            </#if>

                    <#if pagelist.getCurrentPage() gte pagelist.getTotalPages()>
                        <li class="disabled"><a href="#">下一页</a></li>
                    <#else>
                        <li><a href="/project/user/category/find?currentPage=${pagelist.getCurrentPage() + 1}">下一页</a></li>
                    </#if>
                        </ul>
                    </div>
                </div>
