        ...
        <div class="container-fluid">
            ...
            <#--分页-->
                <div class="col-md-12 column">
                    ...
                    <#else>
                        <li><a href="/project/user/order/findorder?currentPage=${orderList.getCurrentPage() - 1}">上一页</a></li>
                    </#if>
                    ...
                    <#--<#list 1..uplist.getTotalPages() as index>
                        ...
                        <#else>
                            ...
                            <#if (orderList.getTotalPages() > 0)>
                                <li <#if (orderList.getCurrentPage() == 1)>class="disabled"</#if>><a href="/project/user/order/findorder?currentPage=1">1</a></li>
                            </#if>
                    ...
                    <#--如果不只有一页-->
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < orderList.getTotalPages())>
                                        <li <#if (orderList.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/order/findorder?currentPage=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
                            ...
                            <#--最后页&ndash;&gt;-->
                                <li <#if (orderList.getCurrentPage() == orderList.getTotalPages())>class="disabled"</#if>><a href="/project/user/order/findorder?currentPage=${orderList.getTotalPages()}" >${orderList.getTotalPages()}</a></li>
                            </#if>

                    <#if orderList.getCurrentPage() gte orderList.getTotalPages()>
                        <li class="disabled"><a href="#">下一页</a></li>
                    <#else>
                        <li><a href="/project/user/order/findorder?currentPage=${orderList.getCurrentPage() + 1}">下一页</a></li>
                    </#if>
                    </ul>
                </div>
            </div>
