                    ...
                    <#--<#list 1..pagelist.getTotalPages() as index>
                        ...
                        <#else>
                            ...
                            <#if (pagelist.getTotalPages() > 0)>
                                <li <#if (pagelist.getCurrentPage() == 1)>class="disabled"</#if>><a href="/project/user/finduser?currentPage=1">1</a></li>
                            </#if>
                        ...
                        <#--如果不只有一页-->
                            ...
                            <#--当前页的前3页和后3页-->
                                ...
                                <#--如果位于第一页和最后一页之间-->
                                    <#if (index > 1) && (index < pagelist.getTotalPages())>
                                        <li <#if (pagelist.getCurrentPage() == index)>class="disabled"</#if>><a href="/project/user/finduser?currentPage=${index}" >${index}</a></li>
                                    </#if>
                                </#list>
                            ...
                            <#--最后页&ndash;&gt;-->
                                <li <#if (pagelist.getCurrentPage() == pagelist.getTotalPages())>class="disabled"</#if>><a href="/project/user/finduser?currentPage=${pagelist.getTotalPages()}" >${pagelist.getTotalPages()}</a></li>
                            </#if>
